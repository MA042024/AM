...
urlpatterns = [
  ...
  re_path(r"^visu/live-insights/mix-types/", toolsviews.live_insights_mix_types, name='live_insights_mix_types'),
  re_path(r"^visu/live-insights/years/", toolsviews.live_insights_years, name='live_insights_years'),
  re_path(r"^visu/live-insights/binder-grades/", toolsviews.live_insights_binder_grades, name='live_insights_binder_grades'),
