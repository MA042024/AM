...
urlpatterns = [
    ...
    re_path(r"^", include('mdcs.Visualization.tools_urls')),
    re_path(r"^", include('mdcs.downloadexcel_urls')),
    re_path(r"^", include('mdcs.Prediction.Prediction_urls')),
    re_path(r"^tutorial/", views.tutorial_view, name='tutorial'),
    re_path(r"^exa/", views.exa_view, name='exa'),
