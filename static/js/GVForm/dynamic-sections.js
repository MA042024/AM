...
function addStiffReplication(containerId, theclass) {
    ...
    newField.innerHTML = `
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <button id="changefrequencytimeStiff${newIndex}" style="display: none; padding: 5px 10px; font-size: 10px;" type="button">Change</button>
        </div>
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <button id="changestraindisplacementStiff${newIndex}" style="display: none; padding: 5px 10px; font-size: 10px;" type="button">Change</button>
        </div>
